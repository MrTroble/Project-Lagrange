...
public:
  ...
  T P5Dfunctions(T x, int i) const {
    ...
    switch (i) {
      case 0:
        return -1.0 / T(24.0)
               * (3125 * x4 - 7500 * x3 + 6375 * x2
                  - 2250 * x + 274);
      case 1:
        return 25.0 / T(24.0)
               * (625 * x4 - 1400 * x3 + 1065 * x2
                  - 308 * x + 24);
      case 2:
        return -25.0 / T(12.0)
               * (625 * x4 - 1300 * x3 + 885 * x2
                  - 214 * x + 12);
      case 3:
        return 25.0 / T(12.0)
               * (625 * x4 - 1200 * x3 + 735 * x2
                  - 156 * x + 8);
      case 4:
        return -25.0 / T(24.0)
               * (625 * x4 - 1100 * x3 + 615 * x2
                  - 122 * x + 6);
      case 5:
        return 1.0 / T(24.0)
               * (3125 * x4 - 5000 * x3 + 2625 * x2
                  - 500 * x + 24);
      default: THROW("Not implemented!")
    }
  }
...
public:
  T P6functions(T x, int i) const {
    switch (i) {
      case 0:
        return 1.0 / T(10.0) * (x - 1) * (2 * x - 1) * (3 * x - 2)
               * (3 * x - 1) * (6 * x - 5) * (6 * x - 1);
      case 1:
    ...
    switch (i) {
      case 0:
        return 1.0 / T(10.0) * (12 * x - 7)
               * (324 * x4 - 756 * x3 + 609 * x2
                  - 196 * x + 21);
      case 1:
        return -36.0 / T(5.0)
               * (324 * x5 - 900 * x4 + 930 * x3
                  - 435 * x2 + 87 * x - 5);
      case 2:
        return 9.0 / T(2.0)
               * (1296 * x5 - 3420 * x4 + 3288 * x3
                  - 1383 * x2 + 234 * x - 10);
      case 3:
        return -8 * (2 * x - 1) * (18 * x2 - 18 * x + 1)
               * (27 * x2 - 27 * x + 5);
      case 4:
        return 9.0 / T(2.0)
               * (1296 * x5 - 3060 * x4 + 2568 * x3
                  - 921 * x2 + 132 * x - 5);
      case 5:
        return -36.0 / T(5.0)
               * (324 * x5 - 720 * x4 + 570 * x3
                  - 195 * x2 + 27 * x - 1);
      case 6:
        return 1.0 / T(10.0) * (12 * x - 5)
               * (324 * x4 - 540 * x3 + 285 * x2
                  - 50 * x + 2);
      default: THROW("Not implemented!")
    }
  }
...
public:
  ...
  T P7Dfunctions(T x, int i) const {
    ...
    switch (i) {
      case 0:
        return -1.0 / T(720.0)
               * (823543 * x6 - 2823576 * x5
                  + 3865610 * x4 - 2689120 * x3
      ...
      case 7:
        return 1.0 / T(720.0)
               * (823543 * x6 - 2117682 * x5
                  + 2100875 * x4 - 1008420 * x3
    ...
    switch (i) {
      ...
      case 1:
        return -64.0 / T(315.0)
               * (131072 * x7 - 501760 * x6
                  + 784896 * x5 - 644000 * x4
                  + 294784 * x3 - 73290 * x2 + 8658 * x
                  - 315);
      case 2:
        return 16.0 / T(45.0)
               * (262144 * x7 - 974848 * x6
                  + 1468416 * x5 - 1145600 * x4
                  + 489248 * x3 - 110118 * x2
                  + 11178 * x - 315);
      case 3:
        return -64.0 / T(45.0)
      ...
      case 5:
        return -64.0 / T(45.0)
               * (131072 * x7 - 444416 * x6
                  + 600576 * x5 - 412960 * x4
                  + 152704 * x3 - 29346 * x2 + 2538 * x
                  - 63);
      case 6:
        return 16.0 / T(45.0)
               * (262144 * x7 - 860160 * x6
                  + 1124352 * x5 - 748800 * x4
                  + 269088 * x3 - 50490 * x2 + 4286 * x
                  - 105);
      case 7:
        return -64.0 / T(315.0)
               * (131072 * x7 - 415744 * x6
                  + 526848 * x5 - 341600 * x4
                  + 120064 * x3 - 22134 * x2 + 1854 * x
                  - 45);
      case 8:
...
public:
  ...
  T P6Dfunctions(T x, int i) const {
    ...
    switch (i) {
      ...
      case 5:
        return 1 / T(5.0)
               * (1620 * x4 - 2160 * x3 + 945 * x * x
                  - 150 * x + 6);
      case 6:
        return 1 / T(10.0)
               * (3888 * x5 - 8100 * x4 + 6120 * x3
                  - 2025 * x * x + 274 * x - 10);
      default: THROW("Not implemented!")
    }
  }
...
public:
  T P7functions(T x, int i) const {
    ...
    switch (i) {
      ...
      case 5:
        return 1 / T(120.0)
               * (84035 * x4 - 96040 * x3 + 36015 * x * x
                  - 4900 * x + 168);
      case 6:
        return 1 / T(720.0)
               * (705894 * x5 - 1260525 * x4
                  + 816340 * x3 - 231525 * x * x + 26852 * x
                  - 840);
      case 7:
        return 1 / T(720.0)
               * (823543 * x6 - 2117682 * x5
...
public:
  T P8functions(T x, int i) const {
    ...
    switch (i) {
      ...
      case 5:
        return 1 / T(15.0)
               * (20480 * x4 - 20480 * x3 + 6720 * x * x
                  - 800 * x + 24);
      case 6:
        return 1 / T(45.0)
               * (98304 * x5 - 153600 * x4
                  + 87040 * x3 - 21600 * x * x + 2192 * x - 60);
      case 7:
        return 1 / T(315.0)
               * (917504 * x6 - 2064384 * x5
                  + 1792000 * x4 - 752640 * x3
                  + 155904 * x * x - 14112 * x + 360);
      case 8:
        return 1 / T(315.0)
               * (1048576 * x7 - 3211264 * x6
                  + 3956736 * x5 - 2508800 * x4
                  + 866432 * x3 - 157584 * x * x + 13068 * x
                  - 315);
    }
    THROW("Not implemented!")
  }
